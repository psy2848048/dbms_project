...
void Row::insert(string f1, string f2, string f3, string f4){
	SSN = atol(f1.c_str());
	FirstName = assignVarChar(f2, 30);
	LastName = assignVarChar(f3, 30);
	city = assignVarChar(f4, 2);
}

void Row::insert(long f1, string f2, string f3, string f4){
	SSN = f1;
	FirstName = assignVarChar(f2, 30);
	LastName = assignVarChar(f3, 30);
	city = assignVarChar(f4, 2);
...
/* depricated
void Row::update(long f1, string f2, string f3, string f4){
